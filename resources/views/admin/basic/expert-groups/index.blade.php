...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Expertgroups</h3>
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('expertgroups'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/admin/basic/expert-groups/create') }}">
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/admin/basic/expert-groups/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/admin/basic/expert-groups/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>Title</th><th>State</th><th>Created By</th><th>Updated By</th>
                            ...
                            @foreach($expertgroups as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->title }}</td><td>{{ $item->state }}</td><td>{{ $item->created_by }}</td><td>{{ $item->updated_by }}</td>
                                    ...
                                    <td>
                                      ...
                                      @can('edit-'.str_slug('ExpertGroup'))

                                          {!! Form::open([
                                                'method'=>'PUT',
                                                'url' => ['/admin/basic/expert-groups/update-state'],
                                    ...
                                    <td>
                                        @can('view-'.str_slug('expertgroups'))
                                            <a href="{{ url('/admin/basic/expert-groups/' . $item->id) }}"
                                               title="View ExpertGroup" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('expertgroups'))
                                            <a href="{{ url('/admin/basic/expert-groups/' . $item->id . '/edit') }}"
                                               title="Edit ExpertGroup" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('expertgroups'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/admin/basic/expert-groups', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
