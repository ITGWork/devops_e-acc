	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(6):before { content: "ผู้บันทึก"; }
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
					...
					<div class="col-sm-12">
						<h3 class="pull-left">&nbsp;แจ้งผลการประเมิน QC</h3>
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('inform_quality_control'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/esurv/inform_quality_control/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('inform_quality_control'))
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/esurv/inform_quality_control/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/esurv/inform_quality_control/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tbody>
                            @foreach($inform_quality_control as $item)
                                <tr>
                                    ...
                                    <td class="text-top">{{ $item->tb3_Tisno }}</td>
																		<td class="text-top">
                                    ...
                                    <td class="text-top">
                                        @can('view-'.str_slug('inform_quality_control'))
                                            <a href="{{ url('/esurv/inform_quality_control/' . $item->id) }}"
                                               title="View inform_quality_control" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('inform_quality_control'))
																					@if($item->state=='0')
                                            <a href="{{ url('/esurv/inform_quality_control/' . $item->id . '/edit') }}"
                                               title="Edit inform_quality_control" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('inform_quality_control'))
                                            ...
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/esurv/inform_quality_control', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete inform_quality_control',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $inform_quality_control->appends(['search' => Request::get('search'),
