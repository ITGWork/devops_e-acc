            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                      ...
                      @can('add-'.str_slug('inform_qc'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/esurv/inform_qc/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('inform_qc'))
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/esurv/inform_qc/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/esurv/inform_qc/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                                ...
                                <tr>
                                    ...
                                    <td class="text-top">
                                        @can('view-'.str_slug('inform_qc'))
                                            <a href="{{ url('/esurv/inform_qc/' . $item->id) }}"
                                               title="View inform_qc" class="btn btn-info btn-xs">
                                                  <i class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                        @endcan

                                        @can('edit-'.str_slug('inform_qc'))
                                            <a href="{{ url('/esurv/inform_qc/' . $item->id . '/edit') }}"
                                               title="Edit inform_qc" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('inform_qc'))
                                            {!! Form::open([
                                                            'method'=>'DELETE',
                                                            'url' => ['/esurv/inform_qc', $item->id],
                                                            'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
                                                    'type' => 'submit',
                                                    'class' => 'btn btn-danger btn-xs',
                                                    'title' => 'Delete inform_qc',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $inform_qc->appends(['search' => Request::get('search'),
