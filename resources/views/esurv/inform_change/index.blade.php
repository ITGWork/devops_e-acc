...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
						...
						<div class="col-sm-12">
							<h3 class="pull-left">&nbsp;แจ้งการเปลี่ยนแปลงที่มีผลกระทบต่อคุณภาพ</h3>
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="pull-right">
                      ...
                      @can('edit-'.str_slug('inform_change'))
                      ...
                      @can('add-'.str_slug('inform_change'))
                          <a class="btn btn-success btn-sm waves-effect waves-light" href="{{ url('/esurv/inform_change/create') }}">
                            <span class="btn-label"><i class="fa fa-plus"></i></span><b>เพิ่ม</b>
                          </a>
                      @endcan

                      @can('delete-'.str_slug('inform_change'))
                    ...
                    <div class="table-responsive">
                      ...
                      {!! Form::open(['url' => '/esurv/inform_change/multiple', 'method' => 'delete', 'id' => 'myForm', 'class'=>'hide']) !!}

                      {!! Form::close() !!}

                      {!! Form::open(['url' => '/esurv/inform_change/update-state', 'method' => 'put', 'id' => 'myFormState', 'class'=>'hide']) !!}
                      ...
                      {!! Form::close() !!}
                        ...
                        <table class="table table-borderless" id="myTable">
                            ...
                            <tr>
                                ...
                                <th>@sortablelink('created_by', 'วันที่แจ้ง')</th>
																...
																<th>@sortablelink('detail', 'รายละเอียดการเปลี่ยนแปลง')</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-top">
                                        @can('view-'.str_slug('inform_change'))
                                            <a href="{{ url('/esurv/inform_change/' . $item->id) }}"
                                               title="View inform_change" class="btn btn-info btn-xs">
                                        ...
                                        @can('edit-'.str_slug('inform_change'))
																						@if($item->state=='0')
	                                            <a href="{{ url('/esurv/inform_change/' . $item->id . '/edit') }}"
	                                               title="Edit inform_change" class="btn btn-primary btn-xs">
                                        ...
                                        @can('delete-'.str_slug('inform_change'))
	                                            ...
	                                            {!! Form::open([
	                                                            'method'=>'DELETE',
	                                                            'url' => ['/esurv/inform_change', $item->id],
	                                                            'style' => 'display:inline'
	                                            ]) !!}
	                                            {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i>', array(
	                                                    'type' => 'submit',
	                                                    'class' => 'btn btn-danger btn-xs',
	                                                    'title' => 'Delete inform_change',
                        ...
                        <div class="pagination-wrapper">
                          {!!
                              $inform_change->appends(['search' => Request::get('search'),
